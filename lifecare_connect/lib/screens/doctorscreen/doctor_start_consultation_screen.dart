...
class DoctorStartConsultationScreen extends StatelessWidget {
  ...
  const DoctorStartConsultationScreen({
    super.key,
              ...
              children: [
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    onPressed: () => _viewPatientHistory(context),
                  ),
                ),
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Ensure patient privacy and confidentiality during all consultations. Follow medical ethics guidelines.',
  ...
  void _addNotes(BuildContext context) {
    _showComingSoonDialog(context, 'Add Notes');
  }
  ...
  void _showComingSoonDialog(BuildContext context, String feature) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            Icon(Icons.upcoming, color: Colors.indigo.shade600),
            const SizedBox(width: 8),
