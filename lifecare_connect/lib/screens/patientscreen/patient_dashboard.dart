        ...
        return FutureBuilder<String?>(
          ...
          builder: (ctx, rt) {
            ...
            if (role == 'patient') {
              ...
              Future.microtask(() => ctx.go('/doctor_dashboard'));
              return const SplashScreen(message: 'Redirecting to doctor dashboard...');
            } else if (role == 'admin') {
              Future.microtask(() => ctx.go('/admin_dashboard'));
              return const SplashScreen(message: 'Redirecting to admin dashboard...');
            } else {
              return const ErrorScreen(message: 'Unknown user role.');
            }
          },
        );
      },
